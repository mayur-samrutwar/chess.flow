...
const Claim = () => {
  ...
  const [headline, setHeadline] = useState(
    "Early Access Pass - Flow Conference 2023"
  );
    ...
    <div>
      <div className="px-40 z-10">
        ...
        <div className="grid grid-cols-3 gap-8 ">
          <div class="w-96 h-80 rounded-lg overflow-hidden relative shadow-xl">
            ...
            <div class="absolute top-12 inset-x-8 bottom-32 bg-white bg-opacity-60 py-12 pl-12 pr-16 rounded-lg backdrop-filter backdrop-blur-sm">
              <span class="text-black font-semibold text-xl">{headline}</span>
              <span class="text-6xl absolute -top-10 -left-5">&#127852;</span>
            </div>
