...
const LoginPage = () => {
  ...
  const { login, playwithai } = useContext(AuthContext);
  const [username, setUsername] = useState("");
  const [password, setPassword] = useState("");

  const handleLogin = () => {
    // Perform login logic and authentication
    // Assuming successful login, update the isLoggedIn state
    login();
    playwithai();
    ...
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <section class="">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div class="w-full bg-white rounded-lg border shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
